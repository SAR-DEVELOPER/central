                ...
                <div className="relative w-full overflow-hidden rounded-xl border border-slate-200 shadow-sm bg-white p-8 sm:p-12">
                  <div className="prose prose-slate max-w-none text-slate-900">
                    ...
                    <div className="mb-6 space-y-1">
                      ...
                      <p className="mb-0">Kepala Satuan Pengawas Internal (SPI)</p>
                      <p className="mb-0">Badan Usaha Milik Negara (BUMN) dan Anak Perusahaan BUMN</p>
                    ...
                    <div className="space-y-4 text-justify leading-relaxed">
                      ...
                      <p className="mb-4">
                        Sehubungan dengan posisi Bapak/Ibu sebagai Kepala Satuan Pengawas Internal (SPI) selaku Fungsi Audit Internal di BUMN maka kuesioner yang diisi berkaitan dengan <b>Interaksi Auditor Internal dengan Komite Audit</b> dan <b>Interaksi Auditor Internal dengan Auditor Eksternal</b>.
                      </p>
